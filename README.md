...
git clone [https://github.com/CoderxX22/CartGenie.git](https://github.com/CoderxX22/CartGenie.git)
...
```bash
  npx expo start -c
```
4. Scan the new QR code with the specific CartGenie app installed on your phone.
