...
export default function AllergiesScreen() {
  ...
  const selectAll = () => setSelected(new Set(ALLERGENS));
      ...
      <View style={styles.container}>
        <View style={styles.card}>
          ...
          <View style={styles.actionsRow}>
            <TouchableOpacity style={[styles.pillButton, styles.pillPrimary]} onPress={selectAll} activeOpacity={0.9}>
              <Ionicons name="checkmark-done" size={16} color="#fff" />
              <Text style={styles.pillPrimaryText}>Select All</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.pillButton} onPress={clearAll} activeOpacity={0.9}>
